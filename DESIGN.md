...
- **Caption:** `.services-half-kicker` — small mono label "The menu" sits above the `Nails` / `Lashes` title in the text column. Bone at 0.6 alpha (legible on the plum wash). JetBrains Mono 11px uppercase.
